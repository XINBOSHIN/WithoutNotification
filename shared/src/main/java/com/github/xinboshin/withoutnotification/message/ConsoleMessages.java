...
public class ConsoleMessages {
    ...
    public static final String[] ASK_SETUP = {
            "----------------------[ ПРОЧТИ МЕНЯ ]----------------------",
            " Это ваш первый запуск с WithoutnNotification.",
            "Запустите команду 'wn setup', чтобы",
            "применить безопасный профиль для улучшения взаимодействия",
            "Это не заставит игроков подписывать свои сообщения",
            "Спасибо за использование WithoutnNotification!",
            "-------------------------------------------------------"
    };
    ...
    public static final String[] ASK_BSTATS = {
            ...
            "значение конфигурации поможет мне улучшить WithoutnNotification.",
